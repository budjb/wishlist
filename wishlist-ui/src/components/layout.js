...
const Footer = () => {
  return (
    <footer className="d-flex flex-row align-items-center position-relative">
      ...
      <ExternalLink
        href="https://github.com/budjb/wishlist"
        title="Fork me on GitHub"
        className="fork-me d-flex flex-column align-self-end justify-content-end align-items-end"
      >
        <div className="p-1">
          <FontAwesomeIcon icon={faGithub} />
        </div>
...
export default ({ children }) => {
  return (
    <div className="main-container d-flex flex-column">
      ...
      <main className="px-1 px-md-2 py-5 flex-grow-1">{children}</main>
      <Footer />
    </div>
  );
};
